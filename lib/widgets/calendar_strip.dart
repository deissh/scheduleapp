...
// Copyright (c) 2019, Siddharth V Sakre <siddharthsakre@gmail.com>
// All rights reserved.
//
// ORIGINAL REPO: https://github.com/IronLad85/flutter_calendar_strip
// LICENSE: https://github.com/IronLad85/flutter_calendar_strip/blob/master/LICENSE
//
// CHANGES:
//  1. fix show, ability show only one week
//  2. localization
//  3. ...
...
class CalendarStripState extends State<CalendarStrip>
  ...
  Map<String, bool> calculateDateRange(mode) {
    if (doesDateRangeExists) {
      return {
        "isEndingWeekOnRange": true,
        "isStartingWeekOnRange": true
      };
    } else {
